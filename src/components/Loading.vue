<template>
    ...
    >
        <div v-if="showing" :class="{'align-self-center mx-auto text-center ml-auto mr-auto white-overlay': overlay}">
            <div class="loader-wrapper">
                <div class="loading label_loading" style="padding: 0 0 100px 0;">{{label}}</div>
                <div class="wrapper_bg loading">
